...
class ImagenEditingViewModel @Inject constructor(private val imagenDataSource: ImagenEditingDataSource) : ViewModel() {
    ...
    /**
     * Called when the user wants to start masking an image.
     */
    ...
    /**
     * Called when the mask is generated by ImageMaskEditor.
     */
    fun onImageMaskReady(originalBitmap: Bitmap, maskBitmap: Bitmap) {
        ...
        _showMaskEditor.value = false // Hide the editor
        _bitmapForMasking.value = null // Clear the bitmap for masking
    }

    /**
     * Called if the user cancels or dismisses the mask editor.
     */
    fun onCancelMasking() {
