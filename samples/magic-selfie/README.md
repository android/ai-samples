...
Here is the key snippet of code that orchestrates the magic selfie creation from [`MagicSelfieViewModel.kt`](./src/main/kotlincom/android/ai/samples/magicselfie/ui/MagicSelfieViewModel.kt):
