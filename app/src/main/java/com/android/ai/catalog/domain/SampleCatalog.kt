...
import com.android.ai.samples.genaiprompt.PhotoQualityScreen
...
val sampleCatalog = listOf(
    ...
    SampleCatalogItem(
        title = R.string.genai_prompt_sample_list_title,
        description = R.string.genai_prompt_sample_list_description,
        route = "PhotoQualityScreen",
        sampleEntryScreen = { PhotoQualityScreen() },
        tags = listOf(SampleTags.GEMINI_NANO, SampleTags.ML_KIT),
        keyArt = R.drawable.img_keyart_img_desc,
    ),
    SampleCatalogItem(
